  ...
  categoryButtonAll = () => {
    ...
    AsyncStorage.getItem("sessionToken")
      ...
      .then(() => {
        const that = this;
        axios
          .get(`${currentHostedLink}/recipe_list/${sessionToken}`)
    ...
    if (this.state.compLoaded) {
      const list = this.state.recipes.map((recipe, index) => (
        <Recipe
          navigate={navigate}
          recipe={recipe}
          color={diffstyle(recipe.difficulty)}
          key={index}
        />
      ));
          ...
          <View style={SearchStyles.header}>
            <View style={SearchStyles.buttonContainer}>
              <View style={SearchStyles.categoryButtonGreasy}>
                <Button title="Greasy" onPress={this.categoryButtonGreasy} />
              </View>
              ...
              <View style={SearchStyles.categoryButtonAll}>
                <Button title="All" onPress={this.categoryButtonAll} />
              </View>
            </View>
          </View>
